...
model {
 // alpha ~ normal(0.0, 10); // normal prior
 // beta ~ normal(0.0, 0.5); // normal prior
 alpha ~ exponential(0.1); // exponential prior
 beta ~ exponential(0.1); // exponential prior
 nu ~ gamma(2,0.1);
...
generated quantities {
 ...
 for (n in 1:N) {
  ...
  y_rep[n] = student_t_rng(nu, x[n] * beta + alpha, sigma);
 }
...
mu_tau_summary <- summary(fit, pars = c("alpha", "beta", "sigma", "nu"))$summary
